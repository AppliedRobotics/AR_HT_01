...
class ScanFixer(Node):
    def __init__(self):
        ...
        self.sub_1 = self.create_subscription(LaserScan, 'scan_2_wr', self.sc_cb, QoSProfile(depth=10, reliability=ReliabilityPolicy.BEST_EFFORT))
        self.scan_pub = self.create_publisher(LaserScan, "scan_2", 10)
